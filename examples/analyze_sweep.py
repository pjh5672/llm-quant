"""Re-analyse a finished sweep without re-running it (no GPU, no model).
    ...
    python examples/analyze_sweep.py experiments/phase1-sweep/sweep.json
"""
...
from llmquant.analysis import format_report, summarize
from llmquant.args.selection import SelectionConfig


def main():
    p = argparse.ArgumentParser(description=__doc__)
    p.add_argument("path", type=Path, help="sweep.json produced by examples/scheme_sweep.py")
